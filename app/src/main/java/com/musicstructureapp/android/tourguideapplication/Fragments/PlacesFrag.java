...
public class PlacesFrag extends Fragment {
    ...
    public void getItemsList() {
        ...
        attraction.add(new ItemModel(R.string.lorem, R.drawable.plac2, R.string.place));
        attraction.add(new ItemModel(R.string.lorem, R.drawable.plac3, R.string.place));
